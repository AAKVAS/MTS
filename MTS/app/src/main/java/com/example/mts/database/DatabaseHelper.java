...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private void insertConnectedEquipment(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO switchboard (building_id, model_id) VALUES (1, 1)");
        db.execSQL("INSERT INTO switchboard (building_id, model_id) VALUES (1, 1)");
        db.execSQL("INSERT INTO switchboard (building_id, model_id) VALUES (1, 1)");
        db.execSQL("INSERT INTO switchboard (building_id, model_id) VALUES (2, 1)");
        db.execSQL("INSERT INTO switchboard (building_id, model_id) VALUES (3, 3)");
        db.execSQL("INSERT INTO switchboard (building_id, model_id) VALUES (3, 3)");
        db.execSQL("INSERT INTO switchboard (building_id, model_id) VALUES (4, 2)");
        ...
        db.execSQL("INSERT INTO connected_equipment (switchboard_id, port_number, cable_id, cable_length, ip, mac) VALUES (1, 3, 1, 25, '112.24.47.10', '99:B8:81:B7:A3:21')");
        db.execSQL("INSERT INTO connected_equipment (switchboard_id, port_number, cable_id, cable_length, ip, mac) VALUES (1, 4, 1, 27, '112.24.47.11', '99:81:B7:A3:2C:B3')");
        db.execSQL("INSERT INTO connected_equipment (switchboard_id, port_number, cable_id, cable_length, ip, mac) VALUES (1, 5, 1, 37, '112.24.47.14', '91:E2:0B:24:3B:15')");
        db.execSQL("INSERT INTO connected_equipment (switchboard_id, port_number, cable_id, cable_length, ip, mac) VALUES (1, 6, 1, 17, '112.24.47.15', '21:D6:EF:52:A4:FD')");
        ...
        db.execSQL("INSERT INTO connected_equipment (switchboard_id, port_number, cable_id, cable_length, ip, mac) VALUES (1, 8, 1, 12, '112.24.47.20', 'DD:6D:59:B5:04:0E')");
        db.execSQL("INSERT INTO connected_equipment (switchboard_id, port_number, cable_id, cable_length, ip, mac) VALUES (1, 9, 1, 22, '112.24.47.21', 'D5:AA:34:0B:FF:82')");
    }
}